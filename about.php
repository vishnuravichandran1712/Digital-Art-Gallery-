  ...
  <section class="about-container">
    ...
    <div class="about-content2">
      <p class="ap1">
        ...
        <img src="image/create-your-gallery.jpg" alt="" width="500px" height="270px">
    </div>
   
  </section>
  <img src="image/bg.jpg" alt="" height="500px" width="100%">
  <section class="about-container">
    <div class="about-header">
      <center><h1>COLLECTION & ARTIST </h1></center>
    </div>
    <div class="about-content1">
      ...
      <p class="ap">
        ...
        Our digital art Gallery  is currently looking for artists in the areas of digital drawing, 2D & 3D animation and video art..</p>
    </div>
   
  </section>

  <footer class="footer">
    <img src="image/Group 1.png" alt="Logo" width="150px">
  </footer>
